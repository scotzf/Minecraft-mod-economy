...
import com.pisomarket.shop.PisoShopMenu;

// Same background as vanilla's chest screen (ContainerScreen), copied by
// hand because that class is hardcoded to ChestMenu specifically and can't
// be reused for a different AbstractContainerMenu subclass. Uses vanilla's
// own generic_54.png texture, cropped to 3 rows — no custom art needed.
public class PisoShopScreen extends AbstractContainerScreen<PisoShopMenu> {
	...
	public PisoShopScreen(final PisoShopMenu menu, final Inventory inventory, final Component title) {
